...
//
// query selector all (this is for all selectors)
//
...
for(x in result5){
    ...
    result5[x].style.padding = "10px";
    result5[x].style.color = "white";
}
...
function myFunction(){
    ...
    console.log(document.getElementById("myH1").getAttribute("class"));
}
